...
class DirectUploadController extends Controller
{
    ...
    public function getPresignedUrl(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            'type' => 'required|in:videos,audios,thumbnails,documents,documents/distinciones,documents/publicaciones,documents/ley24325,documents/baselegal,documents/indecopi,hero,music,images,images/estandartes,images/comunicados,images/publicaciones',
